        ...
        for (int64_t i3 = 0; i3 < d1; i3+=2) {
          for (int64_t i12 = 0; i12 < d23_half; i12+=VLEN) {
            const int64_t vl = d23_half - i12 < VLEN ? d23_half - i12 : VLEN ;
             ;
            __vr vr_in_0 = _vel_vld_vssl(8, pi+2*i12+(i3  )*d23, vl) ;
            __vr vr_in_1 = _vel_vld_vssl(8, pi+2*i12+(i3+1)*d23, vl) ;
            _vel_vst_vssl(_vel_vshf_vvvsl(vr_in_0, vr_in_1, VE_VSHUFFLE_ZLYL, vl), 8*d1, po+d1*(2*i12  )+i3, vl) ;
            _vel_vst_vssl(_vel_vshf_vvvsl(vr_in_0, vr_in_1, VE_VSHUFFLE_ZUYU, vl), 8*d1, po+d1*(2*i12+1)+i3, vl) ;
          }
        }
        pi += d1*d2*d3 ;
        po += d1*d2*d3 ;
        ...
        for (int64_t i3 = 0; i3 < d1; ++i3) {
          for (int64_t i12 = 0; i12 < d23; i12+=VLEN) {
            const int64_t vl = d23 - i12 < VLEN ? d23 - i12 : VLEN ;
             ;
            __vr vr_in = _vel_vldu_vssl(4, pi+i12+i3*d23, vl) ;
            _vel_vstu_vssl(vr_in, 4*d1, po+d1*i12+i3, vl) ;
          }
        }
        pi += d1*d2*d3 ;
        po += d1*d2*d3 ;
      ...
      for (int64_t i12 = 0; i12 < d23; ++i12) {
        for (int64_t i3 = 0; i3 < d1; i3+=VLEN) {
          const int64_t vl = d1 - i3 < VLEN ? d1 - i3 : VLEN ;
           ;
          __vr vr_in = _vel_vldu_vssl(4*d23, pi+i12+i3*d23, vl) ;
          _vel_vstu_vssl(vr_in, 4, po+d1*i12+i3, vl) ;
        }
      }
      pi += d1*d2*d3 ;
      po += d1*d2*d3 ;
        ...
        for (int64_t i1 = 0; i1 < d3; i1+=2) {
          for (int64_t i23 = 0; i23 < d12_half; i23+=VLEN) {
            const int64_t vl = d12_half - i23 < VLEN ? d12_half - i23 : VLEN ;
             ;
            __vr vr_in_0 = _vel_vld_vssl(8*d3, pi+i1+(2*i23  )*d3, vl) ;
            __vr vr_in_1 = _vel_vld_vssl(8*d3, pi+i1+(2*i23+1)*d3, vl) ;
            _vel_vst_vssl(_vel_vshf_vvvsl(vr_in_0, vr_in_1, VE_VSHUFFLE_ZLYL , vl), 8, po+(i1+0)*d12+2*i23, vl) ;
            _vel_vst_vssl(_vel_vshf_vvvsl(vr_in_0, vr_in_1, VE_VSHUFFLE_ZUYU , vl), 8, po+(i1+1)*d12+2*i23, vl) ;
          }
        }
        pi += d1*d2*d3 ;
        po += d1*d2*d3 ;
        ...
        for (int64_t i1 = 0; i1 < d3; i1+=2) {
          for (int64_t i23 = 0; i23 < d12; i23+=VLEN) {
            const int64_t vl = d12 - i23 < VLEN ? d12 - i23 : VLEN ;
             ;
            __vr vr_in = _vel_vld_vssl(4*d3, pi+i1+i23*d3, vl) ;
            _vel_vstl_vssl(vr_in, 4, po+(i1+0)*d12+i23, vl) ;
            _vel_vstu_vssl(vr_in, 4, po+(i1+1)*d12+i23, vl) ;
          }
        }
        pi += d1*d2*d3 ;
        po += d1*d2*d3 ;
    ...
    for (int64_t i0 = 0; i0 < d0; ++i0) {
      for (int64_t i1 = 0; i1 < d3; ++i1) {
        for (int64_t i23 = 0; i23 < d12; i23+=VLEN) {
          const int64_t vl = d12 - i23 < VLEN ? d12 - i23 : VLEN ;
           ;
          __vr vr_in = _vel_vldu_vssl(4*d3, pi+i1+i23*d3, vl) ;
          _vel_vstu_vssl(vr_in, 4, po+i1*d12+i23, vl) ;
        }
      }
      pi += d1*d2*d3 ;
      po += d1*d2*d3 ;
